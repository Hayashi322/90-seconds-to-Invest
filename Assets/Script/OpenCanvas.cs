...
public class OpenCanvas : MonoBehaviour
{
   ...
   public void openCanvas(int number)
    ...
    {
        for (int i = 0; i < canvas.Length; i++)  //»Ô´Ë¹éÒµèÒ§·Ñé§ËÁ´
        {
            canvas[i].alpha = 0;
    ...
    /* public void openCanvas1()
     {
         Debug.Log("opencanvas");              
         canvas[0].alpha = 1;                   //·ÓãËéÁÍ§àËç¹canvas
         canvas[0].blocksRaycasts = true;       //·ÓãËéÂÔ§àÅá¤Êä´é äÁè·ÐÅØcanvas
         canvas[0].interactable = true;         //·ÓãËéÊÒÁÒÃ¶¡´»ØèÁã¹canvasä´é
     }
